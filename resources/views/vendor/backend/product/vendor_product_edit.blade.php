...
<div class="page-content">
  ...
  <div class="card">
      <div class="card-body p-4">
          ...
          <form method="post" id="myForm" action="{{route('vendor.update.product')}}">
            @csrf
               ...
               <div class="border border-3 p-4 rounded">
                 <div class="mb-3 form-group">
                  ...
                  <div class="mb-3">
                    ...
                    <textarea class="form-control" name="long_descp" id="floraeditor">{!! $products->long_descp !!}</textarea>
                  </div>
                ...
                <div class="border border-3 p-4 rounded">
                  <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <div class="col-md-6">
                        <div class="form-check">
                                <input class="form-check-input" name="special_offer" type="checkbox" value="1" {{ $products->special_offer ==1 ? 'checked' : '' }}>
...
{{-- ///////////////  Main Image Thambnail Update Section ///////////////// --}}

<div class="page-content">
<h6 class="mb-0 text-uppercase">Update Main Thambnail</h6>
<hr>
<div class="card">
    <form method="post" action="{{route('vendor.update.product.thambnail')}}" enctype="multipart/form-data">
        ...
        <div class="card-body">
            <div class="mb-3">
                <label for="formFile" class="form-label">Choose Thambnail</label>
...
{{-- ///////////////  End Main Image Thambnail Update Section ///////////////// --}}


{{-- ///////////////  Update MultiImage Section ///////////////// --}}
            ...
            <tbody>
                <form method="post" action="{{route('vendor.update.product.multiimage')}}" enctype="multipart/form-data">
                    ...
                    <tr>
                        ...
                        <td><img src="{{ asset($img->photo_name) }}" alt="" style="width: 60px; height: 60px;"></td>
                        <td><input type="file" class="form-group" name="multi_img[{{ $img->id }}]"></td>
                        <td>
                            <input type="submit" class="btn btn-primary px-4" value="Update Image"/>
                            <a href="{{ route('vendor.product.multiimage.delete',$img->id) }}" class="btn btn-danger" id="delete" title="Delete"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </form>
    ...
    $(document).ready(function (){
        $('#myForm').validate({
            ...
            messages :{
                ...
                multi_img: {
                    required : 'Please Enter Multi Image',
                },
                selling_price: {
...
{{-- ////////////////   Select Category automatical show Subcategory Script /////////////////// --}}
