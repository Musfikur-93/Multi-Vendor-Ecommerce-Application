               ...
               <div class="border border-3 p-4 rounded">
                 <div class="mb-3 form-group">
                  ...
                  <div class="mb-3">
                    ...
                    <textarea class="form-control" name="long_descp" id="floraeditor"></textarea>
                  </div>

                  <div class="mb-3 form-group">
                    <label for="inputProductDescription" class="form-label">Product Thambnail</label>
                    <input name="product_thambnail" class="form-control" type="file" onChange="mainThambUrl(this)">
...
<script type="text/javascript">
    $(document).ready(function(){
      $('select[name="category_id"]').on('change', function(){
        ...
        if (category_id) {
          $.ajax({
            url: "{{ url('/vendor/subcategory') }}/"+category_id,
            type: "GET",
            dataType: "json",
