...
<div class="page-content">
  ...
  <div class="card">
      <div class="card-body p-4">
          ...
          <form method="post" id="myForm" action="{{route('update.product')}}">
            @csrf
                ...
                <form method="post" action="{{route('update.product.multiimage')}}" enctype="multipart/form-data">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('product.multiimage.delete',$img->id) }}" class="btn btn-danger" id="delete" title="Delete"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </form>
