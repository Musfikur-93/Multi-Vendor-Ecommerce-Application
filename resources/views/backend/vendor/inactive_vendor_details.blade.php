					...
					<div class="card">
						<div class="card-body">
							...
							<div class="row mb-3">
								...
								<div class="col-sm-9 text-secondary">
									<textarea class="form-control" name="vendor_short_info" id="inputAddress2" placeholder="Short Info..." rows="3">{{$inactiveVendorDetails->vendor_short_info}}</textarea>
								</div>
							</div>
							<div class="row mb-3">
								<div class="col-sm-3">
								...
								<div class="col-sm-9 text-secondary">
									<img id="showImage" src="{{ (!empty($inactiveVendorDetails->photo)) ? url('upload/vendor_images/'.$inactiveVendorDetails->photo):url('upload/no_image.jpg') }}" alt="Vendor" style="width:100px;">
								</div>
							</div>
