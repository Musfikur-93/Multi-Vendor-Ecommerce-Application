...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
             ...
             <form action="{{ route('checkout.store') }}" method="post">
                ...
                <div class="row">
                    <div class="form-group col-lg-6">
                        <input type="text" required="" name="shipping_name" placeholder="Name *" value="{{ Auth::user()->name }}">
                    </div>
                    <div class="form-group col-lg-6">
        ...
        <table class="table no-border">
            <tbody>
                ...
                <tr>
                    <td class="image product-thumbnail"><img src="{{ asset($item->options->image) }}" alt="#" style="width: 100px; height: 100px;"></td>
                    <td>
