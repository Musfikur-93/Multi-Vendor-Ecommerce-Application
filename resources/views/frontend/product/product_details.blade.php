                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="detail-info pr-30 pl-30">
                            ...
                            @if ($product->vendor_id == NULL)
                                Sold By: <a href="#"><span class="text-brand">Admin</span></a>
                            @else
                                Sold By: <a href="#"><span class="text-brand">{{ $product['vendor']['name'] }}</span></a>
                            @endif
                                ...
                                <div class="vendor-logo d-flex mb-30">
                                    ...
                                    @if ($product->vendor_id == NULL)
                                        <ul class="contact-infor mb-50">
                                            <li><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-location.svg') }}" alt="" /><strong>Address: </strong> <span> Mirpur, Dhaka-1216.</span></li>
                                            <li><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-contact.svg') }}" alt="" /><strong>Contact Seller:</strong><span> +02568794</span></li>
                                        </ul>
                            ...
                            <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap hover-up">
                                    ...
                                    <div class="product-content-wrap">
                                        <h2><a href="{{ url('product/details/'.$product->id.'/'.$product->product_slug) }}" tabindex="0">{{ Str::limit($product->product_name,40) }}</a></h2>
